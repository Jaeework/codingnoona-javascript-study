...
- 뉴스를 검색할 수 있다.
- 웹사이트는 반응형 웹페이지다.
- pagination으로 다음 뉴스 정보를 받아볼 수 있다.
### 3.2 뉴스 타임즈 만들기 이어서...
...
- [x] 전반적인 CSS 스타일 개선
- [x] << >> 버튼 추가하고 제일 처음과 제일 끝 페이지로 이동하도록 구현
- [x] 처음과 끝 페이지에서는 화살표 없애기
- [x] 선택된 카테고리는 배경색을 변경하여 강조되도록 스타일 적용
- [x] 헤드라인 클릭 시 페이지 상태 초기화하도록 구현
